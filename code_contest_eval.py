...
if __name__ == "__main__":
    ...
    parser.add_argument("--k-list", type=int, nargs="+", default=[1, 5, 96,97,100],
    ...
    problem_ids = set(dataset['task_id'])
