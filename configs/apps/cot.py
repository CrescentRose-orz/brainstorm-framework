...
def build_messages(args):
    ...
    def map_message(example):
        ...
        prompt = "Let’s think step by step to come up with a clever solution. First explain you you code, then implement the solution in python3 code." + \
            "Code should be written in a markdown codeblock" + format_str
